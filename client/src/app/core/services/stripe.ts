...
import { CartM } from '../../shared/Models/cart';
  ...
  async createPaymentElement(){
    if(!this.paymentElement){
      ...
      if(elements){
        ...
        throw new Error('Elements instance has not been initized');
      }
    }
...
async createAddressElement(): Promise<StripeAddressElement> {
  ...
  createOrUpdatePaymentIntent(){
    ...
    return this.http.post<CartM>(this.baseUrl + 'payments/' + cart.id, {}).pipe(
      map(cart => {
